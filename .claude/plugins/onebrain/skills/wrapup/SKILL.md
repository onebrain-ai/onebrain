...
**Partition `group_files`. This is the ONE place that decides which bucket a checkpoint lands in — no rule
elsewhere in this skill adds, removes, or overrides a bucket assignment.** Take each checkpoint still on
